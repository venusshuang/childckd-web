package childckd.common.controller;
...
public class PageController {
	...
	// 专家停诊管理
	@RequestMapping("/tingzhen/main_tingzhen.html")
	public String Tingzhen(HttpServletRequest request, ModelMap map) {
		if(!isLoginPC(request)) {
			return "redirect:/manage/login.html";
		}
		...
		return "pc/tingzhen/main_tingzhen";
	}
